 ...
 *  用户投稿视频模型类
 */
class UserContributeInfo : Parcelable {
    ...
    class DataBean : Parcelable {
        ...
        var vlist: List<VlistBean>? = null


        class VlistBean : Parcelable {
            ...
            companion object {
                ...
                val CREATOR: Parcelable.Creator<VlistBean> = object : Parcelable.Creator<VlistBean> {

                    override fun createFromParcel(source: Parcel): VlistBean {

                        return VlistBean(source)
                    }


                    override fun newArray(size: Int): Array<VlistBean?> {
        ...
        protected constructor(`in`: Parcel) {
            ...
            this.vlist = ArrayList<VlistBean>()
            `in`.readList(this.vlist, VlistBean::class.java.classLoader)
        }
    ...
    companion object {
        ...
        val CREATOR: Parcelable.Creator<UserContributeInfo> = object : Parcelable.Creator<UserContributeInfo> {

            override fun createFromParcel(source: Parcel): UserContributeInfo {

                return UserContributeInfo(source)
            }


            override fun newArray(size: Int): Array<UserContributeInfo?> {
