package com.xiangjuncheng.kotlinbilibili.entity.region
 ...
 * 分区数据模型类
 */
class RegionTypesInfo : Parcelable {
    ...
    class DataBean : Parcelable {
        ...
        class ChildrenBean : Parcelable {
            ...
            companion object {
                ...
                val CREATOR: Creator<ChildrenBean> = object : Creator<ChildrenBean> {

                    override fun createFromParcel(source: Parcel): ChildrenBean {

                        return ChildrenBean(source)
                    }
        ...
        protected constructor(`in`: Parcel) {
            ...
            this.gotoX = `in`.readString()
            this.param = `in`.readString()
            this.children = ArrayList<ChildrenBean>()
            `in`.readList(this.children, ChildrenBean::class.java.classLoader)
        }

        companion object {


            val CREATOR: Creator<DataBean> = object : Creator<DataBean> {
    ...
    companion object {
        ...
        val CREATOR: Creator<RegionTypesInfo> = object : Creator<RegionTypesInfo> {

            override fun createFromParcel(source: Parcel): RegionTypesInfo {

                return RegionTypesInfo(source)
            }


            override fun newArray(size: Int): Array<RegionTypesInfo?> {
